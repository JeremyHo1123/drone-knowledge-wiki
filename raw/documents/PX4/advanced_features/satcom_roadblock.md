---
title: "Iridium/RockBlock Satellite Communication System"
type: document
doc_set: PX4
doc_version: main
section: advanced_features
source_url: "https://docs.px4.io/main/en/advanced_features/satcom_roadblock"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced_features/satcom_roadblock.md"
...
![Architecture](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/satcom/architecture.jpg)
...
![Delivery Groups](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/satcom/deliverygroup.png)
...
1. Add a UDP connection in QGC with the parameters:
   ...
   ![High Latency Link Settings](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/satcom/linksettings.png)
...
![udp2rabbit message acknowledge](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/satcom/verification.png)
...
1. Start _QGroundControl_.
   ...
   ![Connect the High Latency link](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/satcom/linkconnect.png)
...
4. Wait until the first `HIGH_LATENCY2` message is received on QGC.
   ...
   ![Link Toolbar](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/satcom/linkindicator.jpg)
...
5. The satellite communication system is now ready to use.
   ...
   - The user can select a priority link over the `LinkIndicator` on the toolbar.
     ...
     ![Prioritylink Selection](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/satcom/linkselection.png)
