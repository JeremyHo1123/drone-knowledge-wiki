---
title: "DJI FlameWheel 450 + CUAV V5 nano Build"
type: document
doc_set: PX4
doc_version: main
section: frames_multicopter
source_url: "https://docs.px4.io/main/en/frames_multicopter/dji_f450_cuav_5nano"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "frames_multicopter/dji_f450_cuav_5nano.md"
...
- **Frame:** DJI F450
- **Flight controller:** [CUAV V5 nano](../flight_controller/autopilot_discontinued.md)
- **Assembly time (approx.):** 90 minutes (45 minutes for frame, 45 minutes autopilot installation/configuration)

![Finished setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/f450_cuav5_nano_complete.jpg)

## Bill of materials

The components needed for this build are:

- Flight controller: [CUAV V5 nano](../flight_controller/autopilot_discontinued.md) (Discontinued):
...
![All components used in this build](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/all_components.jpg)
...
![F450 frame components](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/f450_frame_components.png)
...
![Required tools](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/required_tools.jpg)
...
1. Attach the 4 arms to the bottom plate using the provided screws.
   ...
   ![Arms to bottom plate](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/1_attach_arms_bottom_plate.jpg)

1. Solder ESC (Electronic Speed Controller) to the board, positive (red) and negative (black).

   ![Solder ESCs](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/2_solder_esc.jpg)

1. Solder the Power Module, positive (red) and negative (black).

   ![Solder power module](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/3_solder_power_module.jpg)

1. Plug in the motors to the ESCs according to their positions.

   ![Plug in motors](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/4_plug_in_motors.jpg)

1. Attach the motors to the corresponding arms.

   ![Attach motors to arms (white)](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/5a_attach_motors_to_arms.jpg)
   ![Attach motors to arms (red)](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/5b_attach_motors_to_arms.jpg)

1. Add the top board (screw into the top of the legs).

   ![Add top board](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/6_add_top_board.jpg)

1. Add damping foam to the _CUAV V5 nano_ flight controller.

   ![Damping foam](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/7a_attach_cuav5nano.jpg)
   ![Damping foam](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/7b_attach_cuav5nano.jpg)

1. Attach the FrSky receiver to the bottom board with double-sided tape.

   ![Attach FrSky receiver with double-sided tape](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/8_attach_frsky.jpg)

1. Attach the telemetry module to the vehicle’s bottom board using double-sided tape.

   ![Attach telemetry radio](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/9a_telemtry_radio.jpg)
   ![Attach telemetry radio](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/9b_telemtry_radio.jpg)

1. Put the aluminium standoffs on the button plate and attach GPS.

   ![Aluminium standoffs](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/10_aluminium_standoffs.jpg)
...
1. Plug in Telemetry (`TELEM1`), GPS module (`GPS/SAFETY`), RC receiver (`RC`), all 4 ESC’s (`M1-M4`), and the power module (`Power1`) into the flight controller.
   ![Attach peripherals to flight controller](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/12_fc_attach_periperhals.jpg)
...
- [Airframe](../config/airframe.md)
  ...
  ![QGroundControl - Select Generic Quadcopter](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/dji_f450_cuav_5nano/qgc_airframe_generic_quadx.png)
  :::
