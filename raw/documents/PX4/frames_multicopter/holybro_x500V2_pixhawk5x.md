---
title: "Holybro X500 V2 (Pixhawk 5X Build)"
type: document
doc_set: PX4
doc_version: main
section: frames_multicopter
source_url: "https://docs.px4.io/main/en/frames_multicopter/holybro_x500V2_pixhawk5x"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "frames_multicopter/holybro_x500V2_pixhawk5x.md"
...
![Full X500 V2 Kit](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/x500-kit.png)
...
![X500V2 ARF Kit Full Package Contents](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/x500_v2_whats_inside.png)
...
1. Start by assembling the payload & battery holder.
   ...
   ![Landing Figure 1: Components](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/payload_holder_required_stuff.png)

   _Figure 2_: Payload holder components

   ![Landing Figure 2: Assembled](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/payload_holder_assembled.png)
...
1. The next is to go for attaching the bottom plate to the payload holder.
   ...
   ![Materials to attach bottom plate](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/topplate_holder_stuff.png)

   _Figure 4_: Needed Materials

   ![PDB mountbase](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/powerboard-mountbase.png)

   _Figure 5_: PDB mount base

   ![PDB attachment](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/pdb_bottom_plate.png)

   _Figure 6_: Mounted pdb with nylon nuts

   ![Bottom plate Final](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/bottom_plate_holder_final.png)
...
1. Let's gather the stuff needed for mounting landing gear as Figure 8.
   ...
   ![Attach Landing Gear Stuff](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/landing_gear_materials.png)

   _Figure 8_: Required parts for landing gear attachment

   ![Lanfing great to bottom plate](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/attached_landing_gear.png)
...
1. We will gather all the arms now to mount the top plate.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/needed_stuff_top_plate.png" width="700" title="Arms and top plate materials">

   _Figure 10_: Connecting arms needed materials.

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/guide_for_arm_mount.png" width="700" title="Guide for the arms mount">

   _Figure 11_: Guide for the arms mount

1. Tighten all 16 screws and nuts by using both hex wrench and nut driver.

   ![Top plae mounted](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/finalized_top_plate.png)
...
1. Next you can mount your pixhawk on the top plate by using the stickers.
   ...
   ![Flight controller mounting stickers](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/pixhawk5x_stickertapes.png)
...
1. If you want to mount the GPS on the companion computer plate, you can now secure the GPS mount onto it using 4 screws and nuts.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/gps_mount_plate.png" width="400" title="Secure GPS mount onto companion plate">
...
![Assembled Kit](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/finalized_x500v2_kit.png)
