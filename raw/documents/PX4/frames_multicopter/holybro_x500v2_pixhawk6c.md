---
title: "Holybro X500 V2 + Pixhawk 6C (PX4 Dev Kit)"
type: document
doc_set: PX4
doc_version: main
section: frames_multicopter
source_url: "https://docs.px4.io/main/en/frames_multicopter/holybro_x500v2_pixhawk6c"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "frames_multicopter/holybro_x500v2_pixhawk6c.md"
...
![The fully built vehicle with props removed](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/kit_no_props.jpg)
...
1. Insert the hanger rubber ring gasket in each of their respective hangers.
   ...
   [![Assembly1](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly1.png)](https://www.youtube.com/watch?v=4Tid-FCP_aI)

1. Take the battery mounting board and screw it with the slide bar clip using the Sunk Screw M2.5\*6.

   [![Assembly2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly2.png)](https://youtu.be/9E-rld6tPWQ)

1. Screw 4 hangers to the Platform Board using Sunk Screw M2.5\*6.

   [![Assembly3](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly3.png)](https://youtu.be/4qIBABc9KsY))

1. Take the slide bar and insert 4 hangers to screw to the bottom plate later.

   [![Assembly4](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly4.png)](https://youtu.be/CFx6Ct7FCIc))
...
[![Assembly5](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly5.png)](https://youtu.be/0knU3Q_opEo))

1. Take the bottom plate and insert 4 M3\*14 screws and fasten the nylon standoffs on the same.

   [![Assembly6](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly6.png)](https://youtu.be/IfsMXTr3Uy4)
...
1. Place the Power distribution board and use the locknuts to assemble them. The power module PM02 (for Pixhawk 6C) would power this board
   ...
   [![Assembly7](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly7.png)](https://youtu.be/Qjs6pqarRIY)
...
1. To assemble the landing gear, loosen the pre-assembled screws of the Landing Gear-Cross Bar and insert the Landing Gear-Vertical Pole and fasten the same.
   ...
   [![Assembly8](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly8.png)](https://youtu.be/mU4vm4zyjcY)

   [![Assembly9](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly9.png)](https://youtu.be/7REaF3YAqLg)

1. Use the Socket Cap Screw M3\*8 to screw the landing gears to the bottom plate

   [![Assembly11](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly11.png)](https://youtu.be/iDxzWeyCN54)

   [![Assembly12](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly12.png)](https://youtu.be/3fNJQraCJx0)
...
[![Assembly13](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly13.png)](https://youtu.be/3en4DlQF4XU)
...
![motors_pdb_pixhawk6c](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/motors_pdb_pixhawk6c.png)

Note that the ESC connectors are color-coded and must be inserted in the PWM out such that the white cable faces up.

![esc_connector_pixhawk6c](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/esc_connector.jpg)

### Arms

**Screw-** Socket Cap Screw M3\*38 16pcs | Flange Locknut M3 16pcs

[![Assembly14](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly14.png)](https://youtu.be/66Hfy6ysOpg)
...
1. Putting the arms is quite simple as the motors come pre-assembled.
   ...
   [![Assembly15](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly15.png)](https://youtu.be/45KCey3WiJ4)
...
1. Take one arm and insert the rectangle extrusion inside the rectangular hollow on the bottom plate.
   ...
   [![Assembly16](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly16.png)](https://youtu.be/GOTqmjq9_3s)
...
1. Hold one side using the mini cross wrench provided in the developer kit.
   ...
   [![Assembly17](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly17.png)](https://youtu.be/2rcNVekJQd0)
...
1. Do not fasten any screws before all 3 motors are in place as this might make it difficult while you’re assembling the 3rd and 4th motor.
   ...
   [![Assembly18](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly18.png)](https://youtu.be/SlKRuNoE_AY)

### Propellers

[![Assembly19](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly19.png)](https://youtu.be/yu75VkMaIyc)
...
1. Assemble the GPS by following the video.
   ...
   [![Assembly20](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly20.png)](https://youtu.be/aiFxVJFjlos)
...
1. Screw the GPS mount’s bottom end on the payload holder side using Locknut M3 & Screw M3\*10
   ...
   [![Assembly21](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly21.png)](https://youtu.be/uG5UKy3FrIc)
...
[![Assembly22](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/assembly22.png)](https://youtu.be/wFlr_I3jERQ)
...
![payloads_x500v2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk6c/payloads_x500v2.png)
...
- [Airframe](../config/airframe.md)
  ...
  ![QGroundControl - Select HolyBro 500 airframe](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_v2_holybro_pixhawk5x/x500v2_airframe_qgc.png)
