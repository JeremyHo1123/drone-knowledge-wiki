...
source_url: "https://docs.px4.io/main/en/frames_multicopter/holybro_x500_pixhawk4"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "frames_multicopter/holybro_x500_pixhawk4.md"
...
![Full X500 Kit](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_hero.png)
...
![X500 Full Package Contents](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/whats_inside_x500_labeled.jpg)
...
1. Start by assembling the landing gear.
   ...
   ![Landing Figure 1: Components](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_step_1_fig1.jpg)

   _Figure 2_: Landing gear components

   ![Landing Figure 2: Assembled](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_step_1_fig2.jpg)
...
1. Then put the 4 arms through the 4 motor bases shown in figure 3.
   ...
   ![Attach arms to motor bases](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_step_2_fig3.png)
...
1. Insert 4 nylon screws and nylon standoffs and attach the power module PM07 to the bottom plate using 4 nylon nuts as shown in Figures 4.
   ...
   ![Attach power module](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/power_module.jpg)
...
1. Feed the 4 motor ESCs through each of the arms and connect the 3-wires end to the motors shown in Figure 5.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_fig17.jpg" width="250" title="Connect motors">
...
1. Connect the ESCs power wires onto the power module PM07, black->black and red->red, ESC PWM signal wires goes to "FMU-PWM-Out".
   ...
   ![ESC power module and signal wiring](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/pm07_pwm.jpg)
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/quadx.png" width="240">

   _Figure 7_: Motor order/direction diagram

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/motor_direction1.jpg" width="400">
...
1. Connect the 10 pin cables to FMU-PWM-in, the 6 pin cables to the PWR1 on the PM07 power module.
   ...
   ![Flight controller/Power module PWM and Power connections](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/pm07_cable.jpg)
...
1. If you want to mount the GPS on the top plate, you can now secure the GPS mount onto the top plate using 4 screws and nuts.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/gpsmount.jpg" width="400" title="Secure GPS mount onto top plate">
...
1. Feed the PM07 cables through the top plate.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/top_plate.jpg" width="300">

   _Figure 10-1_: Feed power module cables through top plate

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/ushape.jpg" width="355" title="Connecting top and bottom plate">
...
1. Push the arm tubes a bit into the frame and make sure the amount of protrusion (red square from Figure 11) are consistent on all 4 arms.
   ...
   ![Arms 3](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_fig16.jpg)
...
1. Put the hanger gaskets into the 4 hangers and mount them onto the bottom plate using 8 hex screws (Figure 11).
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_fig9.png" width="400" title="Hanger gaskets">

   _Figure 11_: Hanger gaskets

   ![Battery Mount 4](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_fig10.jpg)
...
1. Insert the slide bars onto the hanger rings (Figure 13).
   ...
   ![Battery Mount 2: Slide bars](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_fig8.png)

   _Figure 13_: Slide bars

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/battery_mount1.jpg" width="400" title="Battery mount on slide bars">
...
1. Mount the landing gear onto the bottom plate.
   ...
   ![Landing Gear](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/x500_fig5.jpg)
...
1. Use the tape and stick the GPS to the top of the GPS mast and mount the GPS mast.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/gps2.jpg" width="400" title="Figure 16: GPS and mast">
...
1. Mount the telemetry radio onto the top plate.
   ...
   ![Pixhawk 4 wiring 1](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/fc_connections.jpg)
...
![Assembled Kit](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/multicopter/x500_holybro_pixhawk4/X500_assembled_frame.jpg)
