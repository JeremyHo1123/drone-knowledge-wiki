---
title: "Bootloader Update Pixhawk V6X-RT via USB"
type: document
doc_set: PX4
doc_version: main
section: advanced_config
source_url: "https://docs.px4.io/main/en/advanced_config/bootloader_update_v6xrt"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced_config/bootloader_update_v6xrt.md"
upstream_commit: "9467506bff09ffe2b4ca5e509c12f9f9b9a1eb55"
ingested: 2026-07-28
tags:
  - docs/px4
  - docs/px4/advanced-config
---
...
1. Install the _MCUXpresso Secure Provisioning_ application and launch the application:
   ...
   ![Flash bootloader through Secure provisioning - Step 1](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step1.png)

1. On first start you have to create a "New Workspace".
   Select `i.mX RT11xx` and then select `MIMXRT1176`

   ![Flash bootloader through Secure provisioning - Step 2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step2.png)

1. After creating a "New Workspace" click on the **FlexSPI NOR - simplified** button

   ![Flash bootloader through Secure provisioning - Step 3](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step3.png)

1. On the _Boot Memory Configuration_ window change the "Device type" to `Macronix Octal DDR` and press **OK**.

![Flash bootloader through Secure provisioning - Step 4](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step4.png)

1. On the menu bar select **Tools > Flash Programmer**:

   ![Flash bootloader through Secure provisioning - Step 5](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step5.png)

1. You should get this pop-up indicating the Pixhawk V6X-RT is not in the "ISP bootloader mode".

   ![Flash bootloader through Secure provisioning - Step 6](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step6.png)
   ...
   1. Launch QGC connect the Pixhawk select **Analayze Tools** and then **MAVLINK Console**.
      ...
      ![ISP bootloader mode](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_enter_isp_qgc.png)
   ...
   2. If the board is bricked and connecting to QGC is not possible you've open the FMUM module and press the BOOT button (circled in red in the picture below) while powering the board.
      ...
      <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_enter_isp_button.jpg" style="zoom:67%;" />
...
1. When the Flash Programming has started you get a popup to configure the target memory press **Yes**
   ...
   ![Flash bootloader through Secure provisioning - Step 7](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step7.png)

1. When the Target Memory configuration is successful you can press the **Erase All** button

   ![Flash bootloader through Secure provisioning - Step 8](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step8.png)

1. After erasing the flash press the **Load ...** button and then press the **Browse** button

   ![Flash bootloader through Secure provisioning - Step 9](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step9.png)

1. Locate the `px4_fmu-v6xrt_bootloader.bin` file and press **Open** and then press on **Load**.

   ![Flash bootloader through Secure provisioning - Step 10](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step10.png)

1. If the load is successful you should see the "Success: load from file" at the bottom right

   ![Flash bootloader through Secure provisioning - Step 11](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step11.png)

1. Press the **Write** button to flash the PX4 bootloader

![Flash bootloader through Secure provisioning - Step 12](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step12.png)
...
1. On success it should show "Success: Write memory 0x30000000 - 0x3XXXXXXX" Note: values might differ due to bootloader changes.
   ...
   ![Flash bootloader through Secure provisioning - Step 13](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/bootloader_6xrt/bootloader_update_v6xrt_step13.png)
