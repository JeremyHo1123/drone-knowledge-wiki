...
source_url: "https://docs.px4.io/main/en/advanced_config/esc_calibration"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced_config/esc_calibration.md"
...
1. Open the _QGroundControl_ **Settings > Power**, then press the **Calibrate** button.
   ...
   ![ESC Calibration step 1](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/esc/qgc_esc_calibration.png)

1. After starting the calibration sequence without error, directly power the ESCs (you should be prompted):

   ![ESC Calibration step 2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/esc/esc_calibration_step_2.png)

   The calibration will begin automatically:

   ![ESC Calibration step 3](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/esc/esc_calibration_step_3.png)
...
1. During the calibration you should hear model-specific beeping from the ESC, which indicates the individual steps of the calibration.
   ...
   ![ESC Calibration step 4](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/esc/esc_calibration_step_4.png)
