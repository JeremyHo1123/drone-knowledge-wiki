---
title: "Compass Power Compensation"
type: document
doc_set: PX4
doc_version: main
section: advanced_config
source_url: "https://docs.px4.io/main/en/advanced_config/compass_power_compensation"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced_config/compass_power_compensation.md"
...
2. There is a strong correlation between the compass readings and the thrust setpoint, and/or the battery current.
   ...
   ![Corrupted mag](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/corrupted_mag.png)
...
5. Secure the drone so that it cannot move, and attach the propellers (so the motors can draw the same current as in flight).
   ...
   ![strap](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/strap.png)
...
8. The script will return the parameter identification for thrust as well as for current and print them to the console.
   ...
   ![line fit](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/line_fit.png)
...
9. Once the parameters are identified, the power compensation must be enabled by setting [CAL_MAG_COMP_TYP](../advanced_config/parameter_reference.md#CAL_MAG_COMP_TYP) to 1 (when using thrust parameters) or 2 (when using current parameters).
   ...
   ![comp params](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/advanced_config/comp_params.png)
