---
title: "PX4 Ethernet Setup"
type: document
doc_set: PX4
doc_version: main
section: advanced_config
source_url: "https://docs.px4.io/main/en/advanced_config/ethernet_setup"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced_config/ethernet_setup.md"
...
1. Start QGroundControl and [define a comm link](https://docs.qgroundcontrol.com/master/en/qgc-user-guide/settings_view/settings_view.html) (**Application Settings > Comm Links**) specifying the _server address_ and port as the IP address and port assigned in PX4, respectively.
   ...
   ![QGC comm link for ethernet setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/settings/comm_link/px4_ethernet_link_config.png)
