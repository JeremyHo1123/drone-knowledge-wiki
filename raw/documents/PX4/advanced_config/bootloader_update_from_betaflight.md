---
title: "PX4 Bootloader Flashing onto Betaflight Systems"
type: document
doc_set: PX4
doc_version: main
section: advanced_config
source_url: "https://docs.px4.io/main/en/advanced_config/bootloader_update_from_betaflight"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced_config/bootloader_update_from_betaflight.md"
...
This page documents how to flash the PX4 bootloader onto boards that are already flashed with Betaflight (e.g. [OmnibusF4 SD](../flight_controller/autopilot_discontinued.md) or [Kakute F7](../flight_controller/autopilot_discontinued.md)).
...
1. Press the **Load Firmware [Local]** button
   ![Betaflight Configurator - Local Firmware](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/omnibus_f4_sd/betaflight_configurator.jpg)
