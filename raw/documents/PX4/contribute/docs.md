...
doc_version: main
section: contribute
source_url: "https://docs.px4.io/main/en/contribute/docs"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "contribute/docs.md"
...
![Vitepress: Edit Page button](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/vuepress/vuepress_edit_page_on_github_link.png)
...
- Images must be stored in a sub folder of `/assets`.
  ...
  ```txt
  ![Image Description](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/path_to_file/filename.jpg)
  ```
