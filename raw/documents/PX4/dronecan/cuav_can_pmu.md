...
doc_version: main
section: dronecan
source_url: "https://docs.px4.io/main/en/dronecan/cuav_can_pmu"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "dronecan/cuav_can_pmu.md"
...
![CAN PMU](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/power_module/cuav_can/can_pmu.jpg)
...
![CAN PMU list](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/power_module/cuav_can/can_pmu_list.png)

### Pinouts

![CAN PMU](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/power_module/cuav_can/can_pmu_pinouts_en.png)

![CAN PMU](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/power_module/cuav_can/can_pmu_pinouts_en2.png)

## Wiring

![CAN PMU](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/power_module/cuav_can/can_pmu_connection_en.png)
...
- [UAVCAN_ENABLE](../advanced_config/parameter_reference.md#UAVCAN_ENABLE): set to: _Sensors Automatic Config_
  ...
  ![qgc set](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/power_module/cuav_can/qgc_set_en.png)

- [UAVCAN_SUB_BAT](../advanced_config/parameter_reference.md#UAVCAN_SUB_BAT): set to: _Raw data_

  ![QGC - Set UAVCAN_SUB_BAT parameter to raw data](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/power_module/cuav_can/qgc_set_usavcan_sub_bat.png)
