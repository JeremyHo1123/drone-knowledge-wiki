---
title: "ARK RTK GPS L1 L5"
type: document
doc_set: PX4
doc_version: main
section: dronecan
source_url: "https://docs.px4.io/main/en/dronecan/ark_rtk_gps_l1_l2"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "dronecan/ark_rtk_gps_l1_l2.md"
...
![ARK RTK GPS L1 L5](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/gps/ark/ark_rtk_gps_l1_l5.jpg)
...
7. Open u-center, select the COM port for the ARK RTK GPS L1 L5 and connect
   ![U-Center Connect](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/gps/ark/ark_rtk_gps_ucenter_connect.png)
8. Check the current firmware version by selecting View, Messages View, UBX, MON, VER
   ![Check Version](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/gps/ark/ark_rtk_gps_ublox_version.png)
9. To update the firmware:
   ...
   6. "Firmware Update SUCCESS" should be displayed if it updated successfully
      ![Firmware Update](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/gps/ark/ark_rtk_gps_ublox_f9p_firmware_update.png)
