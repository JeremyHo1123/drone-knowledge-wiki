---
title: "PX4 Reference Flight Controller Design"
type: document
doc_set: PX4
doc_version: main
section: hardware
source_url: "https://docs.px4.io/main/en/hardware/reference_design"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "hardware/reference_design.md"
...
![PX4 Main/IO Functional Breakdown](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/diagrams/px4_fmu_io_functions.png)
...
You might see this, for example, by running `px4_fmu-v5_default` on [Pixhawk 4](../flight_controller/pixhawk4.md) (with IO) and [Pixhawk 4 Mini](../flight_controller/autopilot_discontinued.md) (without I/O).

:::warning
On [Pixhawk 4 Mini](../flight_controller/autopilot_discontinued.md) this results in a mismatch between the `MAIN` label screenprinted on the flight controller and the `AUX` bus shown during [Actuator Configuration](../config/actuators.md).
