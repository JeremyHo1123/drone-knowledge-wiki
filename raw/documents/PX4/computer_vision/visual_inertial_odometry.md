...
source_url: "https://docs.px4.io/main/en/computer_vision/visual_inertial_odometry"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "computer_vision/visual_inertial_odometry.md"
...
An example of a suitable tracking camera is the [Intel® RealSense™ Tracking Camera T265](../camera/camera_intel_realsense_t265_vio.md).
...
![ekf2_ev_delay log](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/ekf2/ekf2_ev_delay_tuning.png)
...
- **Problem:** I get drift / flyaways when the drone flies, but not when I carry it around with the props off.
  - If using the [T265](../camera/camera_intel_realsense_t265_vio.md) try soft-mounting it (this camera is very sensitive to high-frequency vibrations).
