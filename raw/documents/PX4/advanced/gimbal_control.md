---
title: "Gimbal Configuration"
type: document
doc_set: PX4
doc_version: main
section: advanced
source_url: "https://docs.px4.io/main/en/advanced/gimbal_control"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced/gimbal_control.md"
...
![Gimbal Actuator config](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_actuators_gimbal.png)
...
![Gazebo Gimbal Simulation](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/simulation/gazebo_classic/gimbal-simulation.png)
...
2. Open QGroundControl and enable the on-screen camera control (Application settings).
   ...
   ![Quadrotor(x500) with gimbal (Front-facing) in Gazebo](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/fly/gimbal_control_x500gz.png)
