---
title: "System Notification Tunes"
type: document
doc_set: PX4
doc_version: main
section: advanced
source_url: "https://docs.px4.io/main/en/advanced/system_tunes"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "advanced/system_tunes.md"
...
1. You will then have the option to click through a few screens, then press **1** to display _Melody Master_:
   ![Melody Master 2.1](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/tunes/tunes_melody_master_2_1.jpg)
...
1. Open the file.
   ...
   ![ANSI Output from file](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/tunes/tune_musicmaker_ansi_output.png)
