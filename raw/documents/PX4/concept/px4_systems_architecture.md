...
doc_version: main
section: concept
source_url: "https://docs.px4.io/main/en/concept/px4_systems_architecture"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "concept/px4_systems_architecture.md"
...
Offboard APIs are covered in ROS and [MAVSDK](https://mavsdk.mavlink.io/main/en/).
:::
...
<img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/diagrams/px4_arch_fc.svg" alt="PX4 architecture - FC only system" class="diagram-invert">
...
- The ground station computer typically runs [QGroundControl](../getting_started/px4_basic_concepts.md#qgc) (or some other ground station software).
  It may also run robotics software like [MAVSDK](https://mavsdk.mavlink.io/) or ROS.
...
<img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/diagrams/px4_arch_fc_companion.svg" alt="PX4 architecture - FC + Companion Computer" class="diagram-invert">
