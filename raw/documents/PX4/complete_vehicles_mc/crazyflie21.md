...
source_url: "https://docs.px4.io/main/en/complete_vehicles_mc/crazyflie21"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "complete_vehicles_mc/crazyflie21.md"
...
![Crazyflie2 Image](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie21/crazyflie_2.1.jpg)
...
3. Put the Crazyflie 2.1 into DFU mode by following these steps:
   ...
   - Hold down the reset button (see figure below...).
     ![Crazyflie2 Reset Button](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie/crazyflie_reset_button.jpg)
...
![QGC joystick menu](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie21/joystick_menu_qgc.png)
:::
...
![Crazyflie SDCard](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie21/crazyflie21_sd.jpeg)
...
- Create a new model in Taranis.
  ...
  ![Taranis - new model](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie/taranis_model.jpg)

- In _MODEL SETUP_ menu page, turn off both internal and external TX modules.

  ![Taranis - model setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie/taranis_model_setup.jpg)

- In _OUTPUTS_ menu page (also called “SERVOS” page in some Taranis transmitters), invert Throttle (CH1) and Aileron (CH3).

  ![Taranis - outputs](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie/taranis_outputs.jpg)
...
- In Taranis UI _MIXER_ menu page, you can assign the switches to any channel in the range channel 9-16 which map to the buttons 0-7 in the QGroundControl Joystick setup. For example, Taranis “SD” switch can be set to channel 9 in Taranis UI:
  ...
  ![Taranis switch setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie/taranis_switch_setup.jpg)
...
- In QGroundControl Joystick Setup, you can see the buttons turning yellow when you switch them on. For example, channel 9 in Taranis maps to button 0 in QGroundControl Joystick setup. You can assign any mode to this button e.g. _Altitude_ mode. Now when you lower the switch "SD", flight mode will change to _Altitude_.
  ...
  ![Joystick setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/crazyflie/crazyflie_QGCjoystick_setup.png)
