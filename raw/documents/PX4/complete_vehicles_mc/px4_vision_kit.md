---
title: "PX4 Vision Autonomy Development Kit"
type: document
doc_set: PX4
doc_version: main
section: complete_vehicles_mc
source_url: "https://docs.px4.io/main/en/complete_vehicles_mc/px4_vision_kit"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "complete_vehicles_mc/px4_vision_kit.md"
upstream_commit: "9467506bff09ffe2b4ca5e509c12f9f9b9a1eb55"
ingested: 2026-07-28
tags:
  - docs/px4
  - docs/px4/complete-vehicles-mc
---
...
![Overview](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/px4_vision_v1.5_front.png)
...
1. PX4 Vision v1 with ECN 010 or above (carrier board RC05 and up), the _UP Core_ can be powered by either the DC plug or with battery.
   ...
   ![RC Number](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/rc.png) ![ECN Number](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/serial_number_update.jpg)
...
![Warning - do not connect power port](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/warning_power_port_update.png)
:::
...
![PV4 Vision v1.5](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/px4_vision_v1.5_whats_inside.jpg)
...
1. Raise the GPS mast to the vertical position and screw the cover onto the holder on the base plate. (Not required for v1.5)
   ...
   ![Raise GPS mast](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/raise_gps_mast.jpg)

1. Insert the pre-imaged USB2.0 stick from the kit into the _UP Core_ port labeled `USB1` (highlighted below).

   ![UP Core: USB1 Port ](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/upcore_port_usb1.png)
...
1. Attach the propellers with the rotations as shown:
   ...
   ![Motor Order Diagram](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/motor_order_diagram.png)
   - The propellers directions can be determined from the labels: _6045_ (normal, counter-clockwise) and _6045_**R** (reversed, clockwise).
     ...
     ![Propeller identification](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/propeller_directions.jpg)

   - Screw down firmly using the provided propellor nuts:

     ![Propeller nuts](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/propeller_nuts.png)
...
1. Check that the avoidance system has started properly:
   - The _QGroundControl_ notification log displays the message: **Avoidance system connected**.
     ...
     ![QGC Log showing avoidance system has started](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/qgc_console_vision_system_started.jpg)
...
1. Connect a keyboard and mouse to the _UP Core_ via port `USB2`:
   ...
   ![UP Core: USB2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/upcore_port_usb2.png)
   - Use the USB-JST cable from the kit to get a USB A connector

     ![USB to JST cable](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/usb_jst_cable.jpg)
...
1. Connect a monitor to the _UP Core_ HDMI port.
   ...
   ![UP Core: HDMI port](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/upcore_port_hdmi.png)
...
- Select the _PX4 Vision DevKit_ airframe after loading new firmware:
  ![Airframe Selection - PX4 Vision DevKit](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/px4_vision_devkit/qgc_airframe_px4_vision_devkit_platform.jpg)
