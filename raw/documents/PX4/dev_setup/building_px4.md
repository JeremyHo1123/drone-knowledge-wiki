...
doc_version: main
section: dev_setup
source_url: "https://docs.px4.io/main/en/dev_setup/building_px4"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "dev_setup/building_px4.md"
...
![PX4 Console](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/console_gazebo.png)
...
![Gazebo UI with vehicle taking off](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/gazebo_takeoff.png)
...
![QGroundControl GoTo](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/qgc_goto.jpg)
...
- [Pixhawk 4 Mini (FMUv5)](../flight_controller/autopilot_discontinued.md): `make px4_fmu-v5_default`
- [CUAV V5+ (FMUv5)](../flight_controller/autopilot_discontinued.md): `make px4_fmu-v5_default` - Discontinued
- [CUAV V5 nano (FMUv5)](../flight_controller/autopilot_discontinued.md): `make px4_fmu-v5_default` - Discontinued
- [Pixracer (FMUv4)](../flight_controller/pixracer.md): `make px4_fmu-v4_default`
- [Pixhawk 3 Pro](../flight_controller/autopilot_discontinued.md): `make px4_fmu-v4pro_default`
- [Pixhawk Mini](../flight_controller/autopilot_discontinued.md): `make px4_fmu-v3_default`
...
![Firmware info](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/gcs/qgc_setup_summary_airframe_firmware.jpg)
