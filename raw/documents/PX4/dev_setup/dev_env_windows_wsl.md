---
title: "Windows Development Environment (WSL2-Based)"
type: document
doc_set: PX4
doc_version: main
section: dev_setup
source_url: "https://docs.px4.io/main/en/dev_setup/dev_env_windows_wsl"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "dev_setup/dev_env_windows_wsl.md"
...
![Windows Terminal showing how to select a Ubuntu shell](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/wsl_windows_terminal.png)
...
7. Next time you want to develop WSL2 you can very easily open it again in Remote WSL mode by selecting **Open Recent** (as shown below).
   ...
   ![](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/vscode_wsl.png)
