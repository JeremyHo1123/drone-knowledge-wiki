---
title: "Windows Virtual Machine-Hosted Toolchain"
type: document
doc_set: PX4
doc_version: main
section: dev_setup
source_url: "https://docs.px4.io/main/en/dev_setup/dev_env_windows_vm"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "dev_setup/dev_env_windows_vm.md"
...
3. Download the desired version of [Ubuntu Desktop ISO Image](https://ubuntu.com/download/desktop).
   (see [Linux Instructions Page](dev_env_linux_ubuntu.md) for recommended Ubuntu version).
...
11. Continue with [PX4 environment setup for Linux](dev_env_linux_ubuntu.md)
