---
title: "Windows Development Environment (Cygwin-based)"
type: document
doc_set: PX4
doc_version: main
section: dev_setup
source_url: "https://docs.px4.io/main/en/dev_setup/dev_env_windows_cygwin"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "dev_setup/dev_env_windows_cygwin.md"
...
1. Run it, choose your desired installation location, let it install:
   ...
   ![jMAVSimOnWindows](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/cygwin_toolchain_installer.png)
...
1. For example, to run JMAVSim:
   ...
   ![jMAVSimOnWindows](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/simulation/jmavsim/jmavsim_windows_cygwin.png)
