---
title: "Visual Studio Code IDE (VSCode)"
type: document
doc_set: PX4
doc_version: main
section: dev_setup
source_url: "https://docs.px4.io/main/en/dev_setup/vscode"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "dev_setup/vscode.md"
...
1. Open VSCode and add the PX4 source code:
   - Select _Open folder ..._ option on the welcome page (or using the menu: **File > Open Folder**):
     ...
     ![Open Folder](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/welcome_open_folder.jpg)
...
1. Press **Install All** on the _This workspace has extension recommendations_ prompt (this will appear on the bottom right of the IDE).
   ![Install extensions](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/prompt_install_extensions.jpg)

   VSCode will open the _Extensions_ panel on the left hand side so you can watch the progress of installation.

   ![PX4 loaded into VSCode Explorer](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/installing_extensions.jpg)
...
1. Select your build target ("cmake build config"):
   - The current _cmake build target_ is shown on the blue _config_ bar at the bottom (if this is already your desired target, skip to next step).
     ![Select Cmake build target](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/cmake_build_config.jpg)
   ...
   - _Cmake_ will then configure your project (see notification in bottom right).
     ![Cmake config project](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/cmake_configuring_project.jpg)
   - Wait until configuration completes.
     ...
     ![Cmake config project](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/cmake_configuring_project_done.jpg).

1. You can then kick off a build from the config bar (select either **Build** or **Debug**).
   ![Run debug or build](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/run_debug_build.jpg)
...
1. Select the debug icon on the sidebar (marked in red) to display the debug panel.
   ![Run debug](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/vscode_debug.jpg)
...
![Image showing hardware targets with options for the different probes](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/vscode_hardware_debugging_options.png)
...
![IntelliSense](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/toolchain/vscode/vscode_intellisense.jpg)
