---
title: "Holybro Pixhawk RPi CM4 Baseboard"
type: document
doc_set: PX4
doc_version: main
section: companion_computer
source_url: "https://docs.px4.io/main/en/companion_computer/holybro_pixhawk_rpi_cm4_baseboard"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "companion_computer/holybro_pixhawk_rpi_cm4_baseboard.md"
...
![RPi CM4 with Pixhawk](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_hero.jpg)
...
![Schematic diagram](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_ports.jpg)
...
![Image showing separate baseboard, baseboard cover, RPi, Flight controller, screws](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_disassembled.jpg)

To install the RPi CM4 companion computer:

1. Disconnect the `FAN` wiring.

   ![HB_Pixhawk_CM4_Fan](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_fan.jpg)

1. Remove these 4 screws on the back side of the baseboard.

   ![Bottom of the board showing screws in corners holding the cover](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_bottom.jpg)

1. Remove the baseboard case, install the CM4, and use the 4 screws to attach it (as shown):

   ![HB_Pixhawk_CM4_Screws](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_screws.jpg)
...
![Image showing writing from the PM03D power module to the baseboard](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_wiring_guide.jpg)
...
1. Switch Dip-Switch to `RPI`.
   ...
   ![](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/cm4_dip_switch.png)

1. Connect computer to USB-C _CM4 Slave_ port used to power & flash the RPi.

   ![](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/cm4_usbc_slave_port.png)
...
1. Connect a computer running QGroundControl via USB Type C port on the baseboard labeled `FC`
   ...
   ![Image of baseboard showing FC USB-C connector](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_fc_usb_c.jpg)
...
![HB_Pixhawk_CM4_Ethernet_Cable](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/companion_computer/holybro_pixhawk_rpi_cm4_baseboard/baseboard_ethernet_cable.png)
