---
title: "Video Streaming (Companion Computer/QGroundControl)"
type: document
doc_set: PX4
doc_version: main
section: companion_computer
source_url: "https://docs.px4.io/main/en/companion_computer/video_streaming"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "companion_computer/video_streaming.md"
...
4. If everything works, you should see the video stream displayed in the QGC Video Switcher (QGC Fly View bottom left corner).
   ...
   ![QGC displaying video stream](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/videostreaming/qgc-screenshot.png)
