...
doc_version: main
section: middleware
source_url: "https://docs.px4.io/main/en/middleware/uxrce_dds"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "middleware/uxrce_dds.md"
...
![Architecture uXRCE-DDS with ROS 2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/middleware/xrce_dds/architecture_xrce-dds_ros2.svg)
...
These guidelines explain how to migrate from using PX4 v1.13 Fast-RTPS middleware to PX4 v1.14 `uXRCE-DDS` middleware.
