---
title: "Debugging with Eclipse and J-Link"
type: document
doc_set: PX4
doc_version: main
section: debug
source_url: "https://docs.px4.io/main/en/debug/eclipse_jlink"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "debug/eclipse_jlink.md"
...
6. Set the MCU settings: right-click on the top-level project in the Project Explorer, select _Properties_ then under MCU choose _SEGGER J-Link Path_.
   ...
   ![Eclipse: Segger J-Link Path](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_segger_jlink_path.png)
7. Update packs:
   - Click the small icon on the top right called _Open Perspective_ and open the _Packs_ perspective.
     ![Eclipse: Workspace](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_workspace_perspective.png)
   - Click the **update all** button.
     ...
     ![Eclipse: Workspace Packs Perspective](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_packs_perspective.jpg)
...
8. Setup debug configuration for target:
   ...
   ![Eclipse: Select FMU in settings](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_devices_fmu.png)

9. Select debug configurations with the small drop-down next to the bug symbol:
   ![Eclipse: Debug config](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_debug_config.png)
10. Then select _GDB SEGGER J-Link Debugging_ and then the **New config** button on the top left.
    ![Eclipse: GDB Segger Debug config](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_debug_config_gdb_segger.png)
11. Setup build config:
    ...
    ![Eclipse: GDB Segger Debug config](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_debug_config_gdb_segger_build_config.png)
...
12. The _Debugger_ and _Startup_ tabs shouldn’t need any modifications (just verify your settings with the screenshots below)
    ...
    ![Eclipse: GDB Segger Debug config: debugger tab](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_debug_config_gdb_segger_build_config_debugger_tab.png)
    ![Eclipse: GDB Segger Debug config: startup tab](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_debug_config_gdb_segger_build_config_startup_tab.png)
...
1. You first need to enable `CONFIG_DEBUG_TCBINFO` in the NuttX configuration for your build (to expose the TCB offsets).
   ...
   - Ensure that the _Enable TCBinfo struct for debug_ is selected as shown:
     ![NuttX: Menuconfig: CONFIG_DEBUG_TCBINFO](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/nuttx_tcb_task_aware.png)
...
3. Modify Eclipse to use this library.
   ...
   ![Eclipse: GDB Segger Debug config RTOS aware: debugger tab](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_debug_config_gdb_segger_task_aware.png)

4. When running the debugger you should see now multiple threads instead of just one:

   ![Eclipse: GDB Segger Debug config RTOS aware: debug session](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_settings_debug_config_gdb_segger_task_aware_tasks.png)
...
1. Find out where MCU Eclipse stores its packages (**Preferences > C/C++ > MCU Packages**):
   ...
   ![Eclipse: MCU Packages](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_mcu_packages.png)
...
4. Select desired **.SVD** file in: **Debug Options > GDB SEGGER JLink Debugging > SVD Path**
   ...
   ![Eclipse: SVD File path](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/debug/eclipse_svd_file_path.png)
