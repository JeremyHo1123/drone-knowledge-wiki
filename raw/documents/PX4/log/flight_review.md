---
title: "Log Analysis using Flight Review"
type: document
doc_set: PX4
doc_version: main
section: log
source_url: "https://docs.px4.io/main/en/log/flight_review"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "log/flight_review.md"
...
- Plot background color is used to indicate flight mode during recording (where graphs depend on mode):
  ![Flight Modes](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/flight_modes.png)
...
![Low vibration QAV-R 5 Racer - FFT plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_good_actuator_controls_fft.png)
...
![Low vibration DJI F450 - FFT plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_f450_actuator_controls_fft.png)

S500 frame:

![Low vibration S500 actuator controls - FFT plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_s500_actuator_controls_fft.png)
...
![Vibrations in landing gear - FFT plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_landing_gear_actuator_controls_fft.png)
...
![Low vibration QAV-R 5 Racer - spectral density plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_good_spectral.png)

<!-- https://logs.px4.io/plot_app?log=cd88b091-ec89-457c-85f6-e63e4fa0f51d -->

DJI F450 frame (good vibration).
![Low vibration DJI F450 - spectral density plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_f450_spectral.png)
...
S500 frame:
![Vibration S500 - spectral density plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_s500_spectral.png)
...
![High vibration in spectral density plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_too_high_spectral.png)
...
![Vibrations in landing gear - spectral density plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_landing_gear_spectral.png)
...
![Exceedingly high vibration in spectral density plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_exceedingly_high_spectral.png)
...
![Low vibration QAV-R 5 Racer - raw accel. plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_good_accel.png)

DJI F450 frame (good vibration).
![Low vibration DJI F450 - raw accel. plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_f450_accel.png)
...
![Borderline vibration S500 x, y - raw accel. plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_s500_accel.png)

Vibration too high. Note how the graph of the z-axis overlaps with the x/y-axis graph:

![Vibrations in landing gear - raw accel. plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_landing_gear_accel.png)

Vibration levels are too high. Note how the graph of the z-axis overlaps with the x/y-axis graph:

![High vibration in raw accel. plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_too_high_accel.png)
...
![Exceedingly high vibration in raw accel. plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/vibrations_exceedingly_high_accel.png)
...
![high-rate accel power spectral density](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/accel_spectral_density_fifo.png)
...
![Good actuator outputs](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/actuator_outputs_good.png)
...
- An imbalance can also come from the yaw axis.
  ...
  ![Hexrotor imbalanced actuator outputs](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/actuator_outputs_hex_imbalanced.png)
...
- If the signals look very **noisy** (with high amplitudes), it can have two causes: sensor noise or vibrations passing through the controller (this shows up in other plots as well, see previous section) or too high PID gains.
  ...
  ![Noisy actuator outputs - extreme case](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/actuator_outputs_noisy.png)
...
![GPS jamming - good plot](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/gps_jamming_good.png)
...
![Thrust and mag close to constant](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/thrust_and_mag_good.png)
...
![Correlated thrust and mag](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/thrust_and_mag_correlated.png)
...
![Uncorrelated thrust and mag](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/thrust_and_mag_uncorrelated_problem.png)
...
![Estimator watchdog - good](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/estimator_watchdog_good.png)
...
![Estimator watchdog with magnetometer problems](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/estimator_watchdog_mag_problem.png)
...
![Sampling regularity good](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/sampling_regularity_good.png)
...
![Many Dropouts](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/sampling_regularity_many_drops.png)
...
![Logged Messages](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_log_analysis/flight_review/logged_messages.png)
