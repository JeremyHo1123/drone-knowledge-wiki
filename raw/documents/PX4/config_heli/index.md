---
title: "Helicopter Configuration"
type: document
doc_set: PX4
doc_version: main
section: config_heli
source_url: "https://docs.px4.io/main/en/config_heli/"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config_heli/index.md"
upstream_commit: "9467506bff09ffe2b4ca5e509c12f9f9b9a1eb55"
ingested: 2026-07-28
tags:
  - docs/px4
  - docs/px4/config-heli
---
...
1. Select a helicopter [Airframe](../config/airframe.md) in QGroundControl.
   ...
   ![QGC - helicopter airframe](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/airframe/airframe_heli_generic.png)
...
1. Configure helicopter actuator geometry in **Vehicle Setup > Actuators**.
   ...
   ![Geometry: helicopter](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_geometry_helicopter.png)
   ...
   - `Angle`: Clockwise angle in degree on the swash plate circle at which the servo arm is attached starting from `0` pointing forwards.
     ...
     <img width="700" alt="warning and requirement" src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/helicopter/swash_plate_servo_angles.png">
...
2. Take off slowly and provide some roll and stick movements.
   ...
   ![QGC Rate Controller Tuning UI](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/mc_pid_tuning/qgc_mc_pid_tuning_rate_controller.png)
