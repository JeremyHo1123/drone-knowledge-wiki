...
doc_version: main
section: gps_compass
source_url: "https://docs.px4.io/main/en/gps_compass/rtk_gps"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "gps_compass/rtk_gps.md"
...
1. _QGroundControl_ then starts the RTK setup process (known as "Survey-In").
   ...
   ![survey-in](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/rtk/qgc_rtk_survey-in.png)
...
1. Once Survey-in completes:
   - The RTK GPS icon changes to white and _QGroundControl_ starts to stream position data to the vehicle:
     ...
     ![RTK streaming](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/rtk/qgc_rtk_streaming.png)

   - Vehicle GPS switches to RTK mode.
     The new mode is displayed in the _normal_ GPS status icon (`3D RTK GPS Lock`):

     ![RTK GPS Status](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/rtk/qgc_rtk_gps_status.png)
...
![RTK GPS Setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/rtk/settings_view_general_rtk_gps.jpg)
