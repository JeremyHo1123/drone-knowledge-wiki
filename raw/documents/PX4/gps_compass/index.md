...
doc_version: main
section: gps_compass
source_url: "https://docs.px4.io/main/en/gps_compass/"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "gps_compass/index.md"
...
![GPS + Compass](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/gps/gps_compass.jpg)
...
1. [Find and set](../advanced_config/parameters.md) the parameter [GPS_2_CONFIG](../advanced_config/parameter_reference.md#GPS_2_CONFIG) to **GPS 2**.
   ...
   - Select the **GPS** tab, then open the [GPS_2_CONFIG](../advanced_config/parameter_reference.md#GPS_2_CONFIG) parameter and select `GPS 2` from the dropdown list.
     ...
     ![QGC Serial Example](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/peripherals/qgc_serial_config_example.png)
...
1. Select the **Serial** tab, and open the [SER_GPS2_BAUD](../advanced_config/parameter_reference.md#SER_GPS2_BAUD) parameter (`GPS 2` port baud rate): set it to _Auto_ (or 115200 for the Trimble).
   ...
   ![QGC Serial Baudrate Example](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/peripherals/qgc_serial_baudrate_example.png)
