---
title: "Package Delivery Missions"
type: document
doc_set: PX4
doc_version: main
section: flying
source_url: "https://docs.px4.io/main/en/flying/package_delivery_mission"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "flying/package_delivery_mission.md"
...
1. Add a waypoint on the map for where you'd like to release the package.
   ...
   - If you'd like to land the vehicle to make the delivery you will need to change the `Waypoint` to a `Land` mission item.
     ...
     ![Waypoint to Land mission item](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flying/package_delivery_land_waypoint.png)
...
1. Add a waypoint on the map (anywhere) for the gripper release.
   ...
   ![Action waypoint](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flying/qgc_mission_gripper_mechanism_item_example.png)

1. Configure the action for the gripper in the editor.

   ![Gripper action setting](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flying/qgc_mission_plan_gripper_action_setting.png)
...
![Package drop mission example](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flying/package_drop_mission_example.png)
...
![Land and Release example](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flying/land_and_release_package_delivery_mission_example.png)
