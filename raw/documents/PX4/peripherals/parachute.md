...
doc_version: main
section: peripherals
source_url: "https://docs.px4.io/main/en/peripherals/parachute"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "peripherals/parachute.md"
...
- Assign the _Parachute_ function to any unused output (below we set the `AUX6` output):
  ...
  ![Actuators - Parachute (QGC)](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_actuators_parachute.png)
