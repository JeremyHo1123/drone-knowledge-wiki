...
doc_version: main
section: config
source_url: "https://docs.px4.io/main/en/config/accelerometer"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config/accelerometer.md"
...
1. Click the **Accelerometer** sensor button.
   ...
   ![Accelerometer calibration](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/sensor/accelerometer.png)
...
1. Position the vehicle as guided by the _images_ on the screen.
   ...
   ![Accelerometer calibration](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/sensor/accelerometer_positions_px4.png)
