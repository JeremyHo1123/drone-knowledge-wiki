---
title: "Radio Control (RC) Setup"
type: document
doc_set: PX4
doc_version: main
section: config
source_url: "https://docs.px4.io/main/en/config/radio"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config/radio.md"
...
1. Press **OK** to start the calibration.
   ...
   ![Radio setup - before starting](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/radio_start_setup.jpg)
...
1. Set the [transmitter mode](../getting_started/rc_transmitter_receiver.md#transmitter_modes) radio button that matches your transmitter (this ensures that _QGroundControl_ displays the correct stick positions for you to follow during calibration).
   ...
   ![Radio setup - move sticks](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/radio_sticks_throttle.jpg)
...
<img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/radio_additional_radio_setup.jpg" title="Radio setup - additional settings" width="300px" />
...
1. Press **OK**
   ...
   ![Spektrum Bind](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/radio_additional_setup_spectrum_bind_select_channels.jpg)
...
1. Press **Ok**.
   ...
   ![Copy Trims](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/radio_additional_radio_setup_copy_trims.jpg)
...
1. Specify these channels to map to the AUX1 and AUX2 ports respectively, as shown below.
   ...
   ![AUX1 and AUX2 RC passthrough channels](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/radio_additional_setup_aux_passthrough_channels.jpg)
...
1. Select the mapping of _PARAM Tuning Id_ to radio channels, using the selection lists.
   ...
   ![Map radio channels to tuning channels](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/radio_additional_radio_setup_param_tuning.jpg)
...
1. Click the **Set RC to Param...** button (this will pop-up the foreground dialog displayed below)
   ...
   ![Map tuning channels to parameters](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/radio/parameters_radio_channel_mapping.jpg)
