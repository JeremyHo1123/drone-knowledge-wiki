---
title: "Auto-tuning (Multicopter)"
type: document
doc_set: PX4
doc_version: main
section: config
source_url: "https://docs.px4.io/main/en/config/autotune_mc"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config/autotune_mc.md"
...
3. Enable autotune.
   ...
   ![Tuning Setup > Autotune Enabled](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/autotune/autotune.png) 2. Select either the _Rate Controller_ or _Attitude Controller_ tabs. 3. Ensure that the **Autotune enabled** button is enabled (this will display the **Autotune** button and remove the manual tuning selectors). 4. Read the warning popup and click on **OK** to start tuning.
...
<img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/fw/autotune.png" title="Fixed-Wing Autotune"/>
