...
doc_version: main
section: config
source_url: "https://docs.px4.io/main/en/config/compass"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config/compass.md"
...
3. Click the **Compass** sensor button.
   ...
   ![Select Compass calibration PX4](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/sensor/sensor_compass_select_px4.png)
...
5. Place the vehicle in any of the orientations shown in red (incomplete) and hold it still.
   ...
   ![Compass calibration steps on PX4](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/sensor/sensor_compass_calibrate_px4.png)
