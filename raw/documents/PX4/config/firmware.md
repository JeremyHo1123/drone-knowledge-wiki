...
doc_version: main
section: config
source_url: "https://docs.px4.io/main/en/config/firmware"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config/firmware.md"
...
1. Select **"Q" icon > Vehicle Setup > Firmware** (sidebar) to open _Firmware Setup_.
   ...
   ![Firmware disconnected](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/firmware/firmware_disconnected.png)
...
1. Select the **PX4 Stable Release vX.x.x** option to install the latest stable version of PX4 _for your flight controller_ (autodetected).
   ...
   ![Install PX4 default](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/firmware/firmware_connected_default_px4.png)
...
1. Click the **OK** button to start the update.
   ...
   ![Firmware upgrade complete](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/firmware/firmware_upgrade_complete.png)
...
1. Connect the vehicle as above, and select **PX4 Stable Release vX.x.x**.
   ![Install PX4 version](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/firmware/qgc_choose_firmware.png)
...
![FMUv2 update](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/firmware/bootloader_update.jpg)
