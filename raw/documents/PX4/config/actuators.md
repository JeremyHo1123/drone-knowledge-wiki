---
title: "Actuator Configuration and Testing"
type: document
doc_set: PX4
doc_version: main
section: config
source_url: "https://docs.px4.io/main/en/config/actuators"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config/actuators.md"
...
![Actuators MC (QGC)](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_actuators_mc_aux.png)
...
![Geometry MC (QGC)](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_actuators_mc_geometry_marked.png)
...
![Geometry motor: tailsitter vtol](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_geometry_tailsitter_motors.png)
...
![Geometry motor: tiltrotor vtol](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_geometry_tiltrotor_motors.png)
...
![Geometry motor: standard vtol](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_geometry_standard_vtol_motors.png)
...
![Actuators CG reference diagram](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/quadcopter_actuators_cg_reference.png)
...
![Reversible](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_geometry_reversible_marked.png)
...
![Control Surface Setup Example](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/control_surfaces_geometry.png)
...
![Flaps and spoiler actuator configuration example](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_actuators_tab_flaps_spoiler_setup.png)
...
![Control Surface Deflections](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/plane_control_surface_convention.png)
...
![Tilt Servo Geometry Setup Example](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/tilt_servo_geometry_config.png)
...
![Tilt Axis](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/tilt_axis.png)
...
![Actuator Outputs - Multicopter diagram](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/qgc_actuators_mc_outputs.png)
...
![Actuator Testing Slider](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/vtol_tiltrotor_sliders_example.png)
...
![Identify motor button](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/identify_motors_button.png)
...
1. One motor will start spinning (click **Spin Motor Again** if it stops spinning too quickly to note.)
   ...
   ![Screenshot showing how to identify/assign motors](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/identify_motors_in_progress.png)
...
2. Slowly move the slider up until it snaps to the _minimum_ position.
   ...
   - If the motor is not spinning, or spinning too fast you will need to adjust the corresponding PWM `minimum` value in the [Actuator Outputs](#actuator-outputs) such that the motors barely spin.
     ...
     ![PWM Minimum Output](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/pwm_minimum_output.png)
     ::: info
...
![Control Surface Disarmed 1500 Setting](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/control_surface_disarmed_1500.png)
...
![Asymmetric Servo Deflections](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/servo_pwm_center.png)

To set this up:

1. Set all surface `Trim` to `0.00` for all surfaces:

   ![PWM Trimming](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/control_surface_trim.png)
...
2. Set the `PWM_MAIN_CENTx` / `PWM_AUX_CENTx` value so that the surface will stay at the neutral (aligned with airfoil) position.
   ...
   ![Control Surface Trimming](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/pwm_center_output.png)
...
![Linear PWM Adjustment](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/servo_pwm_linear.png)
:::
...
1. Set the `Disarmed` value so that the surfaces will stay at neutral position when disarmed.
   ...
   ![Control Surface Disarmed 1500 Setting](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/control_surface_aileron_setup.png)
...
3. Move the slider again to the middle and check if the Control Surfaces are aligned in the neutral position of the wing.
   ...
   ![Control Surface Trimming](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/control_surface_trim.png)
   :::
...
![Tilt Servo Setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/tilt_servo_setup.png)
...
2. Position the slider for the servo in the lowest position, and verify that a positive value increase will point towards the `Angle at Min Tilt` (defined in the Geometry section).
   ...
   ![Tilt Servo Geometry Setup](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/tilt_servo_geometry_config.png)
...
- If the ESCs are configured as [DShot](../peripherals/dshot.md) you can permanently reverse the direction via UI.
  ...
  ![Set spin direction buttons](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/config/actuators/reverse_dshot.png)
