---
title: "Multicopter PID Tuning Guide (Manual/Basic)"
type: document
doc_set: PX4
doc_version: main
section: config_mc
source_url: "https://docs.px4.io/main/en/config_mc/pid_tuning_guide_multicopter_basic"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "config_mc/pid_tuning_guide_multicopter_basic.md"
...
- Use [Position mode](../flight_modes_mc/position.md) to tune the _Velocity Controller_ and the _Position Controller_.
  ...
  ![QGC PID tuning: Simple control selector](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/mc_pid_tuning/qgc_mc_pid_tuning_simple_control.png)
