---
title: "OMP Hobby ZMO FPV"
type: document
doc_set: PX4
doc_version: main
section: frames_vtol
source_url: "https://docs.px4.io/main/en/frames_vtol/vtol_tiltrotor_omp_hobby_zmo_fpv"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "frames_vtol/vtol_tiltrotor_omp_hobby_zmo_fpv.md"
...
![Finished ZMO hover 1](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/airframe-hover.jpg)

![Finished ZMO hover 2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/airframe-hover2.jpg)
...
![ZMO FPV in it's original state](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/zmo-01.jpg)

Flight controller and wing connectors removed from the vehicle.

![ZMO FPV with FC and wing connectors removed](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/zmo-02.jpg)
...
1. Solder signal and GND wires to the PWM input to the ESC.
   ...
   ![ESC 01](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/esc-01.jpg)

1. Remove the female banana plug on the ESC.
   This will give you more space to install the flight controller.

   ![ESC 02](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/esc-02.jpg)

1. Solder the rear motor wires to the ESC.
   Make sure to connect such that the motor spins in the correct direction.

   ![ESC 03](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/esc-03.jpg)
...
![Wing connector 01](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/wing-connector-01.jpg)

The connector glued into the fuselage. Make sure to properly align the connector.

![Wing connector 02](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/wing-connector-02.jpg)
...
1. Cut the foam as shown in the pictures to create space to mount the Pixhawk adapter boards and BEC with double sided tape.
   ...
   ![Foam cutout 01](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/foam-cut-01.png)
   ![Pixhawk adapter board mount 01](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/pixhawk-adapter-01.jpg)
...
1. Prepare the BEC to connect to the IO board and to the battery.
   ...
   ![BEC preparation](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/bec-01.jpg)

1. Mount the BEC with double sided tape.

   ![BEC mounting](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/bec-02.jpg)
...
1. Glue the 3D-Printed mount into place.
   ...
   ![Pitot tube 01](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/pitot-tube-01.png)

1. The sensor can be mounted on top of the 3D-Printed mount.

   ![Pitot tube 02](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/pitot-tube-02.png)
...
![Lidar 01](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/lidar-01.jpg)
...
1. Glue the 3D-Printed part with 5 min epoxy in place.
   ![Glue the GPS mount into place](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/gps-01.jpg)
1. After the glue has cured, screw the GPS with 4x M2.5x10 screws to the plate.
   ![Screw the GPS to the mount2](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/gps-02.jpg)
...
1. To install the camera you need to cut a hole into the foam of the wall.
   ...
   ![USB Camera 01: Hole to feed the USB cable through the wall.](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/camera-01.jpg)
...
1. Remove the Skynode from the vehicle and drill 2 holes with a 2.8 mm drill bit into the plastic part.
   ![Mounting holes for the Skynode in the back](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/flight-controller-01.jpg)
...
1. Then add some 5 min epoxy at the bottom of the mount and put a weight on top of the Skynode until the glue is cured.
   ...
   ![Skynode mount in the front](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/flight-controller-02.jpg)
...
1. One LTE antenna can be installed on the bottom of the vehicle.
   ...
   ![LTE antenna 01](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/lte-antenna-01.jpg)
...
1. The second antenna can be installed on the inside of the vehicle on the left side of the battery compartment.
   ...
   ![LTE antenna 2 and RC receiver](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/lte-antenna-02.jpg)
...
1. Check if the motors point upwards.
   ...
   ![Tilt Servo adjustment](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/tilt-limits-01.jpg)
...
![Servo trim](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/omp_hobby_zmo_fpv/servo_trim.png)
