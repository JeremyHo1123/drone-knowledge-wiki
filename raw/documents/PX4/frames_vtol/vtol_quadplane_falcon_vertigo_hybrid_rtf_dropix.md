---
title: "Discontinued: Falcon Vertigo Hybrid VTOL RTF (Dropix)"
type: document
doc_set: PX4
doc_version: main
section: frames_vtol
source_url: "https://docs.px4.io/main/en/frames_vtol/vtol_quadplane_falcon_vertigo_hybrid_rtf_dropix"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "frames_vtol/vtol_quadplane_falcon_vertigo_hybrid_rtf_dropix.md"
...
![Falcon Vertigo Hybrid VTOL RTF](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_complete.jpg)
...
![Build tools](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_build_tools.jpg)
...
1. Spread gorilla glue inside the wing brackets as shown.
   ...
   ![Add glue on wing brackets](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/wing_brackets_glue.jpg)
...
1. Attach the carbon tube in the brackets. The bracket and tube must be aligned using the white mark (as shown in the picture).
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/carbon_tube_in_brackets.jpg" title="Carbon tube in brackets" width="300px" />

1. The following images show the alignment of rods from other viewpoints:

   ![quad motor frame rod alignment from bottom](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_9_bottom_view_rod_alignment.jpg)
   ![quad motor frame rod alignment schematic](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_11_rod_alignment_schamatic.jpg)

### Step 2: Attach the wings

1. Insert both carbon tubes into the fuselage.

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_15_fuselage_tubes.jpg" width="500px" title="Fuselage carbon tubes" />
...
1. Spread gorilla glue between the two white marks on each tube (indicated by the red arrows). The white mark in the center (blue arrow) will be placed in the center of the fuselage and the other marks on the sides.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_13_rod_apply_glue.jpg" width="500px" title="Apply glue to rod" />
...
1. The fuselage has two holes for the motor and servo cables. Pass the cables through the holes and then join the wings to the fuselage.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_17_fuselage_holes_cables.jpg" width="500px" title="Fuselage holes for cables" />
...
1. Within the fuselage connect the signal cables you just passed through from the wings to the ESC using the provided connectors. The ESC are already connected to the motors and set up to turn in the correct order (you will need to connect the ESC PDB to a power module in a later step).
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_19_connect_esc_power_and_signal_cables.jpg" width="500px" title="Connect ESC power and signal cables" />
...
1. As with the ESCs, the servos are already installed. Connect the signal cable from the wing (passed through the fuselage) to the flight controller.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_21_connect_servo_cables.jpg" width="500px" title="Connect servo cables" />
...
<img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_23_dropix_and_other_electronics.jpg" width="500px" title="Falcon Vertigo Electronics" />
...
1. Connect the ESC to the power module using the XT60 connector
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_25_aileron_esc_connections.jpg" width="500px" title="" />

1. Pass the signals cables through to the flight controller

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_27_gps_esc_servo_connections.jpg" width="500px" title="GPS, ESC, Servo connections" />
...
<img id="dropix_outputs" src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_33_dropix_outputs.jpg" width="500px" title="Dropix motor/servo outputs" />
...
1. Connect the throttle motor signal cable from the ESC to the appropriate flight controller auxiliary port. Connect the ESC to the throttle motor.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_37_connect_throttle_motor.jpg" width="500px" title="Connect throttle motor" />
...
<img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/flight_controller/dropix/dropix_connectors_front.jpg" width="500px" alt="Dropix connectors front" title="Dropix connectors front" />

1. Connect the telemetry, airspeed sensor, GPS, buzzer and safety switch as shown.

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_39_connect_sensors.jpg" width="500px" title="Connect sensors" />
...
1. Connect power and USB as shown
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_41_connect_power_module_usb.jpg" width="500px" title="Connect power module and USB" />
...
1. Install the Pitot tube in the front of the plane
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_43_airspeed_sensor_mounting.jpg" width="500px" title="Airspeed sensor mounting" />

1. Secure the connecting tubing and ensure that it is not bent/kinked.

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_45_airspeed_sensor_tubing.jpg" width="500px" title="Airspeed sensor mounting" />

1. Connect the tubes to the airspeed sensor.

   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_47_connect_airspeed_sensor_tubing.jpg" width="500px" title="Connect airspeed sensor and tubing" />
...
1. Paste the receiver and telemetry module to the outside of the vehicle frame.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_49_receiver_mounting.jpg" width="500px" title="Paste receiver" />
...
1. Connect the telemetry module to the _front_ of the flight controller as shown below (see the [flight controller instructions](#dropix_front) for more detail on the pins).
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_51_telemetry_module_mounting.jpg" width="500px" title="Paste telemetry module" />
...
<img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_gps_compass.jpg" width="500px" title="GPS/Compass" />
...
1. Set your flight controller orientation to 270 degrees.
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_53_flight_controller_orientation.jpg" width="500px" title="Flight controller orientation" />
...
1. Check that the motors turn in the correct directions (as in the QuadX diagram below).
   ...
   <img src="https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_35_quad_motor_directions.png" width="200px" title="Quad motor order/directions" />
...
1. Check the vehicle is balanced around the expected centre of gravity
   - Hold the vehicle with your fingers at the center of gravity and check that the vehicle remains stable.
     ...
     ![Level Centre of Gravity](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_57_level_centre_of_gravity.jpg)

   - If the vehicle leans forward or backwards, move the motors to balance it.

     ![Level Motors](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/falcon_vertigo/falcon_vertigo_55_level_motors.jpg)
...
1. For [Airframe](../config/airframe.md) select the vehicle group/type as _Standard VTOL_ and the specific vehicle as [Generic Standard VTOL](../airframes/airframe_reference.md#vtol_standard_vtol_generic_standard_vtol) as shown below.
   ...
   ![QCG - Select Generic Standard VTOL](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/qgc/setup/airframe/px4_frame_generic_standard_vtol.png)
