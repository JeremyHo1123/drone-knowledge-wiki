---
title: "Foxtech Loong 2160 VTOL"
type: document
doc_set: PX4
doc_version: main
section: frames_vtol
source_url: "https://docs.px4.io/main/en/frames_vtol/vtol_quadplane_foxtech_loong_2160"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "frames_vtol/vtol_quadplane_foxtech_loong_2160.md"
...
![Photo of Loong VTOL in flight](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/01-foxtech-loong.jpg)
...
![Complete stack assembly](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/02-stack.png)
...
1. Insert 10x M3 threaded inserts into the baseplate as shown in the picture:
   ...
   ![Baseplate with threaded inserts](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/03-baseplate.jpg)

1. Insert 2x M3 threaded inserts into the stack fixture as shown in the picture below:

   ![Stack fixture with threaded inserts](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/04-stack-fixture.jpg)

1. Insert 2x M4 threaded inserts into the fan mount and radio mount as shown in the picture below.

   ![Radio-mount](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/05-radio-mount.jpg)

   If you would like to add a 40mm 5V fan to the fan mount, insert 4x M3 inserts.

   ![Fan-mount](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/06-fan-mount.jpg)
...
1. Change the cable connector to a servo connector so it can be plugged into the servo rail to be powered.
   ...
   ![Fan-mount with fan](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/07-fan-mount.jpg)

1. Remove the original mounting plate from the vehicle.
   Tape the cables to the outside of the fuselage.

   ![Empty fuselage](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/08-preparations.jpg)
...
![Mounting stack fixture](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/09-stack-fixure.jpg)
...
1. Create a cable to extend the XT60 connector to an XT30 that is mounted on the baseplate.
   ...
   ![40A Power Module installation](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/10-40a-power-module.jpg)
...
1. The sensor can be installed with 2x M3x16mm screws in the front right corner of the baseplate.
   ...
   ![Mounted airspeed sensor](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/11-airspeed-sensor.jpg)
...
1. Mark the location to install the lidar with some tape or a pen.
   ...
   ![Prepared lidar hole](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/12-lidar-01.jpg)

1. Secure the lidar with hot glue.

   ![Installed lidar](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/13-lidar-02.jpg)

#### GPS/Compass

1. Use double sided tape to mount the GPS in the rear of the vehicle underneath the rear latch.

   ![Installed GPS](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes//vtol/foxtech_loong_2160/14-gps.jpg)
...
![Installed Skynode](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/15-skynode.jpg)
...
1. Tape the Skynode LTE antennas to the side of the fuselage as shown in the picture:
   ...
   ![LTE-Antennas](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/16-lte-antennas.jpg)
...
1. If you are using a radio telemetry module you can mount the antennas to the top of the fuselage.
   ...
   ![WIFI-Antennas-Front](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/17-antenna-front.jpg)

   In the back you can use the 3D-Printed antenna adapter.
   The adapter can be glued in place with hot glue.

   ![WIFI-Antenna-Back](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/19-rear-antenna.jpg)
...
![12S-Power-Module](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/airframes/vtol/foxtech_loong_2160/18-12s-power-module.jpg)
