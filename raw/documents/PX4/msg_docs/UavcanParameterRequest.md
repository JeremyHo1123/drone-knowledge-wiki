---
title: "UavcanParameterRequest (UORB message)"
type: document
doc_set: PX4
doc_version: main
section: msg_docs
source_url: "https://docs.px4.io/main/en/msg_docs/UavcanParameterRequest"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "msg_docs/UavcanParameterRequest.md"
...
| <a id="fld_message_type"></a>message_type | `uint8`    |              |            | MAVLink message type: PARAM_REQUEST_READ, PARAM_REQUEST_LIST, PARAM_SET |
...
| <a id="fld_param_index"></a>param_index   | `int16`    |              |            | -1 if the param_id field should be used as identifier                   |
