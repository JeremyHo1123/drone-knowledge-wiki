---
title: "ARK Electron Microhard Serial Telemetry Radios"
type: document
doc_set: PX4
doc_version: main
section: telemetry
source_url: "https://docs.px4.io/main/en/telemetry/ark_microhard_serial"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "telemetry/ark_microhard_serial.md"
...
![Microhard Radio](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/telemetry/ark_microhard_serial.jpg)
...
![Microhard Radio on Vehicle](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/telemetry/microhard_serial_on_vehicle.jpg)
...
- For vehicle radio configuration you will have to connect an FTDI adapter between the radio's 3 pin JST-GH Config port and a Windows PC running _Pico Config_ (the radio must be powered, which you can do from battery or the data connection to the flight-controller's `TELEM1` port).
  ...
  ![Ark Microhard Serial - Ports](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/telemetry/ark_microhard_serial_ports.jpg)
...
![Pico Config](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/hardware/telemetry/pico_configurator.png)
