...
doc_version: main
section: simulation
source_url: "https://docs.px4.io/main/en/simulation/hitl"
upstream_repo: "PX4/PX4-Autopilot"
upstream_path: "simulation/hitl.md"
...
![HITL Setup - jMAVSim and Gazebo Classic](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/simulation/px4_hitl_overview_jmavsim_gazebo.svg)
...
4. Setup UDP
   1. Under the _General_ tab of the settings menu, uncheck all _AutoConnect_ boxes except for **UDP**.
      ...
      ![QGC Auto-connect settings for HITL](https://raw.githubusercontent.com/PX4/PX4-Autopilot/main/docs/assets/gcs/qgc_hitl_autoconnect.png)
