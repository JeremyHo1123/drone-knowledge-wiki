...
section: setup_view
source_url: "https://docs.qgroundcontrol.com/Stable_V5.0/en/qgc-user-guide/setup_view/tuning_px4.html"
upstream_repo: "mavlink/qgroundcontrol"
upstream_path: "setup_view/tuning_px4.md"
...
![Tuning Setup > Autotune](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/tuning/px4_autotune_hero.png)
...
1. In QGroundControl, open the menu: **Vehicle setup > PID Tuning**
   ...
   ![Tuning Setup > Autotune Enabled](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/tuning/px4_autotune.png)
...
1. Select the _Rate Controller_ tab.
   ...
   ![PX4 Tuning - Manual - Rate controller](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/tuning/px4_copter_manual_rate.png)
...
1. Switch to the other controllers and repeat the process.
   ...
   ![PX4 Tuning - Manual - Attitude controller](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/tuning/px4_copter_manual_attitude.png)
   ![PX4 Tuning - Manual - Velocity controller](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/tuning/px4_copter_manual_velocity.png)
   ![PX4 Tuning - Manual - Position controller](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/tuning/px4_copter_manual_velocity.png)
