---
title: "Sensor Setup (ArduPilot)"
type: document
doc_set: QGC
doc_version: Stable_V5.0
section: setup_view
source_url: "https://docs.qgroundcontrol.com/Stable_V5.0/en/qgc-user-guide/setup_view/sensors_ardupilot.html"
upstream_repo: "mavlink/qgroundcontrol"
upstream_path: "setup_view/sensors_ardupilot.md"
...
![Sensors Setup screen Copter](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor/sensor_setup_overview_ardupilot.jpg)
...
1. Click the **Accelerometer** sensor button.
   ![Accelerometer calibration](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor/accelerometer_ardupilot.jpg)
...
1. Position the vehicle based on text instructions in the center display.
   ...
   ![Accelerometer calibration](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor/accelerometer_positions_ardupilot.jpg)
...
![ArduPilot Compass Calibration Onboard Result](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor_compass_ardupilot_onboard_calibration_result.jpg)
...
1. Click the **Calibrate Pressure** button and then **Ok**.
   ...
   ![Calibrate Pressure](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor/calibrate_pressure_ardupilot.jpg)

   The calibration result is immediately displayed:

   ![Calibrate Pressure Result](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor/calibrate_pressure_result_ardupilot.jpg)
...
1. Click the **CompassMot** sensor button.
   ...
   <img src="https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor_compass_mot_menu.jpg" style="width: 250px;"/>

1. Follow the onscreen prompts.

   ![CompassMot calibration](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor_compass_mot.jpg)
...
![Flight Controller Orientation](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/flight_controller_orientation.png)

For example, the image below are at orientations: `ROTATION_NONE`, `ROTATION_YAW_90`,`ROTATION_YAW_180`,`ROTATION_YAW_270`.

![Flight controller yaw rotation](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/flight_controller_yaw_rotation.png)

To set the orientation(s) and compasses used:

1. Select the **Sensor Settings** button.

   ![Sensor Settings](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/setup/sensor/sensor_settings_ardupilot.jpg)
