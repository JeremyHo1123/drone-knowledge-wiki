...
source_url: "https://docs.qgroundcontrol.com/Stable_V5.0/en/qgc-user-guide/analyze_view/mavlink_inspector.html"
upstream_repo: "mavlink/qgroundcontrol"
upstream_path: "analyze_view/mavlink_inspector.md"
...
![MAVLink inspector](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/analyze/mavlink_inspector/mavlink_inspector.jpg)
...
1. Open _Analyze View_ by selecting the _QGroundControl_ application menu ("Q" icon in top left corner) and then choosing the **Analyze Tools** button (from the _Select Tool_ popup).
   ![Analyze ](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/analyze/menu_analyze_tool.png)
1. Select the **MAVLink Inspector** from the sidebar.

   ![MAVLink inspector menu](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/analyze/mavlink_inspector/mavlink_inspector_menu.jpg)
...
1. Select a message to see its fields and their (dynamically updating) value:
   ...
   ![MAVLink inspector: message detail](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/analyze/mavlink_inspector/mavlink_inspector_message_details.jpg)

1. Add fields to charts by enabling the adjacent checkboxes (plot 1 is displayed below plot 2).

   ![MAVLink inspector: chart fields detail](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/analyze/mavlink_inspector/mavlink_inspector_plot1.jpg)
   ...
   - A chart can have multiple fields, and fields from multiple messages (these are listed above each chart).
     ...
     ![MAVLink inspector: chart fields detail](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/analyze/mavlink_inspector/mavlink_inspector_charted_messages.jpg)
