---
title: "QGC v4 Release Notes"
type: document
doc_set: QGC
doc_version: Stable_V5.0
section: releases
source_url: "https://docs.qgroundcontrol.com/Stable_V5.0/en/qgc-user-guide/releases/release_note_stable_v4.html"
upstream_repo: "mavlink/qgroundcontrol"
upstream_path: "releases/release_note_stable_v4.md"
...
- Settings
  ...
  - ArduPilot
    - Support configurable mavlink stream rates. Available from Settings/Mavlink page.
      ![Stream Rates JPG](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/daily_build_changes/arducopter_stream_rates.jpg)
...
- Setup
  ...
  - ArduPilot
    ...
    - ArduCopter
      - PID Tuning support ![PID Tuning JPG](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/daily_build_changes/arducopter_pid_tuning.jpg)
      - Additional Basic Tuning options ![Basic Tuning JPG](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/daily_build_changes/arducopter_basic_tuning.jpg)
      - Copter/Rover - Frame setup ui ![Setup Frame Copter JPG](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/daily_build_changes/arducopter_setup_frame.jpg)
- Plan
