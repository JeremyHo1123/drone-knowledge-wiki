---
title: "Fixed Wing Landing Pattern (Plan Pattern)"
type: document
doc_set: QGC
doc_version: Stable_V5.0
section: plan_view
source_url: "https://docs.qgroundcontrol.com/Stable_V5.0/en/qgc-user-guide/plan_view/pattern_fixed_wing_landing.html"
upstream_repo: "mavlink/qgroundcontrol"
upstream_path: "plan_view/pattern_fixed_wing_landing.md"
...
1. Choose the _Pattern Tool_ from the _Plan Tools_ and then select _Fixed Wing Landing Pattern_.
   ...
   ![Fixed Wing Landing Pattern](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/pattern/fixed_wing_landing_pattern_menu.jpg)

   This will add a _Landing Pattern_ item to the mission list (on the right).

   ![Fixed Wing Landing Pattern](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/pattern/fixed_wing_landing_pattern_mission_item_initial.jpg)
...
![Landing Pattern - Loiter Point](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/pattern/fixed_wing_landing_pattern_settings_loiter.jpg)
...
![Landing Pattern - Landing Point](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/pattern/fixed_wing_landing_pattern_settings_landing.jpg)
