---
title: "Structure Scan (Plan Pattern)"
type: document
doc_set: QGC
doc_version: Stable_V5.0
section: plan_view
source_url: "https://docs.qgroundcontrol.com/Stable_V5.0/en/qgc-user-guide/plan_view/pattern_structure_scan_v2.html"
upstream_repo: "mavlink/qgroundcontrol"
upstream_path: "plan_view/pattern_structure_scan_v2.md"
...
![Structure Scan](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/structure_scan_v2/structure_scan.jpg)
...
![Layer JPG](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/structure_scan_v2/layers.jpg)
...
![Create Scan JPG](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/structure_scan_v2/create_scan.jpg)

1. This will create a simple square structure scan on the map.

   ![Initial Polygon](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/structure_scan_v2/initial_polygon_scan.jpg)
...
1. You can also change to a circular footprint by clicking on the central "vertix" (marked in red) and selecting _Circle_ in the popup menu.
   ...
   ![Circle Scan](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/structure_scan_v2/circle_scan.jpg).
...
1. The rest of the configuration is handled using the _Structure Scan_ editor on the right hand side of the view.
   ...
   ![Structure Scan editor](https://raw.githubusercontent.com/mavlink/qgroundcontrol/Stable_V5.0/docs/assets/plan/structure_scan_v2/editor_options.jpg)
